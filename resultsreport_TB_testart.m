...
for i = 2%:length(subjects) 
    ...
    matfile= cellstr(spm_select('FPListRec', ['/data/cnc/projects/fm/bids/derivatives/test_art/reorientation/', subjcode, '/func/results'] ,'SPM.mat'));
    ...
    cd '/data/cnc/projects/fm/bids/derivatives/test_art'
